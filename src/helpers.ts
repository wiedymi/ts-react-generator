...
export class FileHelper {
  ...
  public static createContainer(
    ...
    let filename = `${componentDir}/container.ts`;
  ...
  public static createComponent(
    ...
    let filename = `${componentDir}/component.tsx`;
  ...
  public static createIndexFile(
    ...
    let templateFileName = container
      ? this.assetRootDir + "/templates/indexContainer.template"
      : this.assetRootDir + "/templates/index.template";
    ...
    let filename = `${componentDir}/index.ts`;
  ...
  public static createCSS(
    ...
    let filename = `${componentDir}/styles.ts`;
...
export default function getConfig(uri?: Uri) {
  return workspace.getConfiguration("TSReactComponentGenerator", uri) as any;
}

export function getStyleSheetExtTemplate() {
  const configuredView = getConfig().get("styleFile.type");
  let styleTemplate = { ext: "ts", template: "css-emotion.template" };
